 /*=============================================================================================//
	...
	Credits to original author of the parts copied from the bare gamemode
 //=============================================================================================*/
...
public OnPlayerRequestClass(playerid, classid)
{
	...
	GivePlayerMoney(playerid, 1); // Give the player a dollar for looking at skins
...
public OnPlayerSpawn(playerid)
{
	...
	TogglePlayerClock(playerid,1); // Show player clock, like in single player
...
public OnPlayerCommandText(playerid, cmdtext[])
{
	...
	if(strcmp(cmd, "/yadayada", true) == 0) {
		SendClientMessage(playerid, 0, " {00FF00}Hello {FFFF00}there{FF0000}!");
    	return 1;
	}
